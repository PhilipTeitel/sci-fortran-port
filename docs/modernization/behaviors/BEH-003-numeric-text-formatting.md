# BEH-003: Numeric text formatting and I/O codec contract
...
| File open failure in fidelity driver | Prints message; `stop 1` | `E3` — `fidelity/driver.f90:43-46` | see BEH-005 / **DEF-009** |
| Tolerance / comparison regimes | Workflow `1e-6` vs script `1e-10` vs probe exact | `E1`/`E2`/`E3` — oracle §6; INT-006 | **DEF-008** open/TBD |
| `r8_to_s_left` comment vs code | Comment G14.6; write `g16.9` | `E3` — `src/COMVARS.f90:495-521` | **DEF-011** open/TBD |
...
- Defect ledger: `docs/modernization/defect-ledger.md` — DEF-008, DEF-011 (open/TBD); complex-column DEF-001–006 via BEH-004
- Related gaps: GAP-007, GAP-009, GAP-013 (column order separated in BEH-004)
- Related behavior: BEH-004 (complex-column order)
